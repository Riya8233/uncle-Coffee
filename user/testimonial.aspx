<%@ Page Title="" Language="C#" MasterPageFile="~/user/umaster.Master" AutoEventWireup="true" CodeBehind="testimonial.aspx.cs" Inherits="The_Bunglow_Cafe.user.WebForm15" %>
...
<!-- Mirrored from html.miraclestudio.design/majesty/testimonials.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Feb 2022 17:19:15 GMT -->
        ...
        <div class="row">
          ...
          <article class="testimonials">
            ...
            <%--<div class="quote_image">
              <div class="col-sm-2 pull-left"> <img src="img/clients/1.jpg" class="img-responsive" alt=""> </div>
            </div>--%>
            <!-- End#Image -->
            <!-- Quote -->
            ...
            <div >
            <form runat ="server">
               <%-- <asp:TextBox ID="txtname" runat="server" class="col-md-7 text-center"></asp:TextBox>--%>
               
                <h3><asp:Label ID="Label1" runat="server" Text="" class="carts-total text-left margin-tb-60"></asp:Label></h3>
                    
               
                <asp:TextBox ID="txtreview"  class="form-control"  runat="server" placeholder="Enter Your Review"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please Enter your Review" ControlToValidate="txtreview" Display="None" EnableViewState="False"></asp:RequiredFieldValidator>

            <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 text-center">        
                <asp:Button ID="Button1" runat="server" Text="Add Review" class="btn form-control btn-black" OnClick="Button1_Click1"/>
...
<!-- Mirrored from html.miraclestudio.design/majesty/testimonials.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Feb 2022 17:19:16 GMT -->
</html>--%>
