<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="The_Bunglow_Cafe.user.login" %>
...
<!-- Mirrored from html.miraclestudio.design/majesty/login_default.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Feb 2022 17:19:23 GMT -->
...
<!-- Your Title Page
    ============================================= -->
<title>The Bungalow Cafe | Login</title>
<!-- Favicon Icons
     ============================================= -->
...
<!-- Loader
    ============================================= -->
<div id="loader">
  <div class="loader-item"> <img src="../logo/white.png" alt="" height="300" width="300">
    <div class="spinner">
...
<div id="wrapper">
  ...
  <section class="banner about dark" >
    <div id="login-parallax">
      <div class="bcg background39"
                data-center="background-position: 50% 0px;"
                data-bottom-top="background-position: 50% 100px;"
                data-top-bottom="background-position: 50% -100px;"
                data-anchor-target="#login-parallax"
              >
          ...
          <div class="banner-content">
            <div class="container" >
              <div class="slider-content  "> <i class="icon-home-ico"></i>
                <h1>Login</h1>
                <p>Login into our amazing resturant</p>
                <ol class="breadcrumb">
                  <li>Home</li>
                  <li>Default Login</li>
                </ol>
  ...
  <div id="content">
    <!-- Login Default 
    ============================================= -->
    <section class="padding-100 text-center login">
      <div class="container">
        <div class="row">
          <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 text-center"> <i class="icon-intro"></i>
            <h1>Login</h1>
            ...
            <div class="form-group padding-50">
              <form runat="server">
                   <asp:Label ID="Label1" runat="server" Text="" class="media-heading" ></asp:Label>
               <%-- <input type="text" class="form-control" placeholder="User Name">--%>
                  <asp:TextBox ID="txtemailid" runat="server" class="form-control" placeholder="Enter Your Email *"></asp:TextBox> <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtemailid" ErrorMessage="Please enter valid Email Id" Display="None" EnableViewState="False">         </asp:RequiredFieldValidator>
                  
                  <asp:TextBox ID="txtpass" runat="server" class="form-control" placeholder="Enter Password *"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Please enter valid password " ControlToValidate="txtpass" Display="None" EnableViewState="False"></asp:RequiredFieldValidator>
                 
                <%--<button type="submit" class="btn form-control btn-black">Login</button>--%>
                  <asp:Button ID="Button1" runat="server" Text="LOGIN" class="btn form-control btn-black" OnClick="Button1_Click" />
            ...
            <div class="forget text-center">
              <p><a href="signup.aspx">Create an account <i class="fa fa-chevron-circle-right"></i></a></p>
              <p><a href="../user/forgotpass.aspx">I've forgotten my password <i class="fa fa-chevron-circle-right"></i></a></p>
