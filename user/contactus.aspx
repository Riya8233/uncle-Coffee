<%@ Page Title="" Language="C#" MasterPageFile="~/user/umaster.Master" AutoEventWireup="true" CodeBehind="contactus.aspx.cs" Inherits="The_Bunglow_Cafe.user.WebForm5" %>
            ...
            <form runat="server">
                  ...
                  <div class="col-md-4 col-sm-4 col-sx-12">
                    ...
                    <div class="element">
                     <%-- <input type="text" name="name" class="form-control text" placeholder="Name *" />--%>
                        <asp:TextBox ID="txtcname" runat="server" class="form-control text" placeholder="Name *" ></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please Enter Your Name" ControlToValidate="txtcname" Display="None" EnableViewState="False"></asp:RequiredFieldValidator>
                    </div>
                    <!-- End Element -->
                  </div>
                  <div class="col-md-4 col-sm-4 col-sx-12">
                    ...
                    <div class="element">
                      <%--<input type="text" name="email" class="form-control text" placeholder="E-mail *" />--%>
                        <asp:TextBox ID="txtcemail" runat="server" class="form-control text" placeholder="E-mail *"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Please Enter Your Email-id" ControlToValidate="txtcemail" Display="None" EnableViewState="False"></asp:RequiredFieldValidator>
                    </div>
                    <!-- End Element -->
                  </div>
                  <div class="col-md-4 col-sm-4 col-sx-12">
                      ...
                      <div>
                        ...
                        <div class="form-group">
                          <%--<textarea name="comment" class="text textarea" placeholder="Message *" ></textarea>--%>
                            <asp:TextBox ID="txtcmsg" runat="server" class="form-control" placeholder="Message *"  cols="20" rows="2"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Please Enter Your Message" ControlToValidate="txtcmsg" Display="None" EnableViewState="False"></asp:RequiredFieldValidator>
              ...
              <div class="element">
               <%-- <button type="submit" id="submit" value="Send" class="btn btn-black">Send</button>--%>
                  <asp:Button ID="Button1" runat="server" Text="Send" class="btn btn-black" OnClick="Button1_Click"  />
                  <asp:ValidationSummary ID="ValidationSummary1" runat="server" ShowMessageBox="True" ShowSummary="False" />
                <div class="loading"></div>
                 
              </div>
                <div class="text-center">
                <div class="fig_container"> <asp:Label ID="Label1" runat="server"></asp:Label></div>
                    </div>
              <!-- End Element -->
            </form>
...
<!-- Mirrored from html.miraclestudio.design/majesty/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Feb 2022 17:19:14 GMT -->
</html>--%>
    </div>
</asp:Content>
