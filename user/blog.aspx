<%@ Page Title="" Language="C#" MasterPageFile="~/user/umaster.Master" AutoEventWireup="true" CodeBehind="blog.aspx.cs" Inherits="The_Bunglow_Cafe.user.WebForm3" %>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="blog-main-content">
            ...
            <div class="blog_row">
              <!-- Blog img -->
              <figure class="blog-img col-md-12"> <a> <img class="img-responsive" src='../blog/<%#Eval("bimage") %>' alt="" /></a>
                <figcaption class="text-center"> <span class="btn btn-gold primary-bg white" ><%#Eval("bdate") %></span> </figcaption>
              </figure>
              <!-- Blog content -->
              <div class="blog-content col-md-12">
                <h2><a><%#Eval("bname") %></a></h2>
               
                <div class="text-content">
                  <h1><p><%#Eval("bdesc") %></p></h1>
                  </div>
              </div>
              <!-- End Blog content -->
            </div>
           ...
           <%-- <div class="blog_row">
              <!-- Blog img -->
              <figure class="blog-img col-md-12"> <a href="blog_single_soundclouds.html"> <img class="img-responsive" src="img/blog/blog-list2.jpg" alt="" /></a>
                <figcaption class="text-center"> <span class="btn btn-gold primary-bg white" >31 March 2022</span> </figcaption>
              </figure>
              <!-- Blog content -->
              <div class="blog-content col-md-12">
                <h2><a href="blog_single_soundclouds.html">Chef Meeting His Lovers </a></h2>
                <!-- Category -->
                <div class="category"> <i class="fa fa-volume-up"></i> EVENTS </div>
                <!--End Category -->
                <!-- Links -->
                <div class="links">
                  <ul>
                ...
                <div class="text-content">
                  ...
                  <a href="blog_single_soundclouds.html" class="btn btn-gold"  data-toggle="tooltip" data-placement="right" title="Read More"><i class="fa fa-arrow-right"></i></a> </div>
              </div>
              <!-- End Blog content -->
            </div>--%>
            <!-- End Blog row -->
           ...
           <%-- <div class="blog_row">
              <!-- Blog img -->
              <figure class="blog-img col-md-12"> <a href="blog_single_video.html"> <img class="img-responsive" src="img/blog/blog-list3.jpg" alt="" /></a>
                <figcaption class="text-center"> <span class="btn btn-gold primary-bg white" >20 APRIL 2015</span> </figcaption>
              </figure>
              <!-- Blog content -->
              <div class="blog-content col-md-12">
                <h2><a href="blog_single_video.html">Come and taste our dinner</a></h2>
                <!-- Category -->
                <div class="category"> <i class="fa fa-video-camera"></i> EVENTS </div>
                <!--End Category -->
                <!-- Links -->
                <div class="links">
                  <ul>
                ...
                <div class="text-content">
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum...</p>
                  <a href="blog_single_video.html" class="btn btn-gold"  data-toggle="tooltip" data-placement="right" title="Read More"><i class="fa fa-arrow-right"></i></a> </div>
              </div>
              <!-- End Blog content -->
            </div>--%>
            <!-- End Blog row -->
           ...
           <%-- <div class="blog_row">
              <!-- Blog img -->
              <figure class="blog-img col-md-12"> <a href="blog_single_image.html"> <img class="img-responsive" src="img/blog/blog-list4.jpg" alt="" /></a>
                <figcaption class="text-center"> <span class="btn btn-gold primary-bg white" >30 DECEMBER 2015</span> </figcaption>
              </figure>
              <!-- Blog content -->
              <div class="blog-content col-md-12">
                <h2><a href="blog_single_image.html">BUY TWO PIZZA AND GET ONE FREE</a></h2>
                <!-- Category -->
           ...
           <%-- <div class="blog_row">
              <!-- Blog img -->
              <figure class="blog-img col-md-12"> <a href="blog_single_image.html"> <img class="img-responsive" src="img/blog/blog-list5.jpg" alt="" /></a>
                <figcaption class="text-center"> <span class="btn btn-gold primary-bg white" >30 DECEMBER 2015</span> </figcaption>
              </figure>
              <!-- Blog content -->
              <div class="blog-content col-md-12">
                <h2><a href="blog_single_image.html">NOW NEW BRANCH IN MAADI IS OPEN</a></h2>
                <!-- Category -->
                <div class="category"> <i class="fa fa-picture-o"></i> NEWS </div>
                <!--End Category -->
                <!-- Links -->
...
<!-- Mirrored from html.miraclestudio.design/majesty/blog_list_style_2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Feb 2022 17:19:11 GMT -->
</html>--%>
