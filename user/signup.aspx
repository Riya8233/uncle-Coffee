<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="signup.aspx.cs" Inherits="The_Bunglow_Cafe.user.signup" %>


<!DOCTYPE html>
<html lang="en">

<!-- Mirrored from html.miraclestudio.design/majesty/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Feb 2022 17:19:23 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <!-- Your Title Page
    ============================================= -->
    <title>The Bungalow Cafe | Register</title>
    <!-- Favicon Icons
     ============================================= -->
                    ...
                    <div class="row">
                        ...
                        <div class="contact-form">
                            <form runat="server">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-4 col-sm-4 col-sx-12">
                                            <!-- Element -->
                                            <div class="element">
                                                <%--<input type="text" name="name" class="form-control text" placeholder="Full Name *" />--%>
                                                <asp:TextBox ID="txtname" runat="server" class="form-control text" placeholder="Full Name *"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please Enter Your Name" ControlToValidate="txtname" Display="None" EnableViewState="False"></asp:RequiredFieldValidator>
                                            </div>
                                            <!-- End Element -->
                                        </div>
                                        <div class="col-md-4 col-sm-4 col-sx-12">
                                            ...
                                            <div class="element">
                                                ...
                                                <asp:TextBox ID="txtemail" runat="server" class="form-control text" placeholder="E-mail *"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Please Enter Your Email Id" ControlToValidate="txtemail" Display="None" EnableViewState="False"></asp:RequiredFieldValidator>
                                        ...
                                        <div class="col-md-4 col-sm-4 col-sx-12">
                                            <!-- Element -->
                                            <div class="element">
                                                <%--<input type="text" name="name" class="form-control text" placeholder="Mobile *" />--%>
                                                <asp:TextBox ID="txtpass" runat="server" class="form-control text" placeholder="password *"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Please enter password" ControlToValidate="txtpass" Display="None" EnableViewState="False"></asp:RequiredFieldValidator>
                                            </div>
                                            <!-- End Element -->
                                        </div>
                                        <div class="col-md-4 col-sm-4 col-sx-12">
                                            ...
                                            <div class="element">
                                                <%--<input type="text" name="name" class="form-control text" placeholder="Mobile *" />--%>
                                                <asp:TextBox ID="txtmobile" runat="server" class="form-control text" placeholder="Mobile *"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Please Enter Your Mobile No." ControlToValidate="txtmobile" EnableViewState="False" Display="None"></asp:RequiredFieldValidator>
                                            </div>
                                            <!-- End Element -->
                                        </div>
                                        ...
                                        <div class="col-md-4 col-sm-4 col-sx-12">
                                            <!-- Element -->
                                            <div class="element">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Please Select Your Gender" ControlToValidate="DropDownList1" Display="None" EnableViewState="False"></asp:RequiredFieldValidator>
                                                <asp:DropDownList ID="DropDownList1" runat="server" class="form-control text" placeholder="Gender">
                                ...
                                <!-- Element -->
                                <div class="element">
                                    <asp:Button ID="Button1" runat="server" Text="Submit" class="btn btn-black" OnClick="Button1_Click1"/>
