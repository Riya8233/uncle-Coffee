...
@push('styles')
    ...
    <style>
        ...
        /* Ensure images inside chatbot messages are always visible */
...
@section('content')
                            ...
                            <div class="d-flex col-lg-3 col-sm-6">
                                <div class="single_product">
                                    ...
                                    <div class="menu_product_info">
                                        <div class="title">
                                            <h5><a href="{{ route('menu.item', $menu->id) }}"> {{ $menu->name }}</a>
                                            </h5>
                                        </div>
    ...
    <div class="section background_bg" data-img-src="/assets/images/cta_bg.jpg">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-7 col-md-9 animation text-center" data-animation="fadeInUp"
                    data-animation-delay="0.02s">
                    <div class="heading_s1 heading_light">
                        <span class="sub_heading font_style1">Experience True Flavor</span>
                        <h2>Where Meals Bring Us Together</h2>
                    </div>
                    <p class="text-white">Celebrate the joy of dining with authentic African dishes, crafted to bring
                        families and friends closer with every bite.</p>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    <div class="input_group">
                                                        <input required="required" placeholder="Name"
                                                            class="form-control rounded-0" name="name" type="text">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <div class="input_group">
                                                        <input required="required" placeholder="Email Address"
                                                            class="form-control rounded-0" name="email" type="email">
                                                        <div class="input_icon">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <div class="input_group">
                                                        <input placeholder="Time"
                                                            class="form-control rounded-0 timepicker" data-theme="red"
                                                            name="time" type="text">
                                                        <div class="input_icon">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <div class="input_group">
                                                        <input required="required" placeholder="Mobile No."
                                                            class="form-control rounded-0" name="phone" type="tel">
                                                        <div class="input_icon">
                                                            <i class="ti-mobile"></i>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group col-md-6">
                                                    <div class="input_group">
                                                        <input placeholder="Select Date"
                                                            class="form-control rounded-0 datepicker" name="date"
                                                            type="text">
                                                        <div class="input_icon">
                                                ...
                                                <div class="col-md-12">
                                                    <button type="submit" title="Submit Your Message!"
                                                        class="btn btn-default rounded-0" name="submit"
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-8 animation" data-animation="fadeInUp" data-animation-delay="0.02s">
                    ...
                    <p class="text-center leads">Hear what our happy customers have to say about their experience with us.
                    </p>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-12 animation" data-animation="fadeInUp" data-animation-delay="0.03s">
                    <div class="testimonial_slider testimonial_style2 carousel_slider owl-carousel owl-theme"
                        data-margin="10" data-loop="true" data-autoplay="true"
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-8 animation" data-animation="fadeInUp" data-animation-delay="0.2s">
                    ...
                    <p class="text-center leads">Explore the stories behind our rich African flavors, our passion for suya,
                        and the art of charcoal grilling.</p>
                </div>
            </div>
            <div class="row justify-content-center">
                ...
                @forelse($blogs as $blog)
                    <div class="d-flex col-lg-4 col-md-6 animation" data-animation="fadeInUp"
    ...
    <div id="chatbotContainer">
        <div class="chatbot-header">🍽️ Food Feedback Survey </div>
        <div id="chatbotMessages" class="chatbot-messages"></div>
        <div class="chatbot-input-area">
            <input type="text" id="chatbotInput" class="chatbot-input" placeholder="Type your answer..."
                style="display: none;">
            <button id="chatbotSend" class="chatbot-send" style="display: none;"> &#x23CE;</button>
        </div>
    </div>
    ...
    <script>
        ...
        const questions = [
            ...
            "How would you rate the food? (1-5)",
            "How would you rate the restaurant? (1-5)",
            "How would you rate the staff? (1-5)"
        ];
        ...
        function askQuestion() {
            if (questionIndex < questions.length) {
                ...
                botMessage.textContent = questions[questionIndex];
                ...
                // Survey complete, display final message
                const botMessage = document.createElement("div");
                botMessage.classList.add("chatbot-message", "bot-message");
                botMessage.textContent = "Thank you for your feedback! 😊";
                chatbotMessages.appendChild(botMessage);
                chatbotMessages.scrollTop = chatbotMessages.scrollHeight;
        ...
        chatbotSend.addEventListener("click", function() {
            ...
            userResponses[keys[questionIndex]] = answer;
