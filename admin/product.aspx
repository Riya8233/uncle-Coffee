<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="product.aspx.cs" Inherits="The_Bunglow_Cafe.admin.WebForm2" %>
                ...
                <div class="card-body">
                    ...
                    <form runat="server">
                        <div class="form-group row">
                            <label for="input-23" class="col-sm-2 col-form-label">Category id</label>
                            <div class="col-sm-10">
                                <%--<input type="text" class="form-control" id="input-23" placeholder="Enter Category Description  ">--%>
                                <asp:TextBox ID="txtcid" runat="server" class="form-control" placeholder="Enter Category Id  "></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <asp:TextBox ID="txtproduct_name" runat="server" class="form-control" placeholder="Enter Product Name"></asp:TextBox>
                            </div>
                        </div>
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                               ...
                               <%-- <asp:Image ID="Image1" runat="server" src='productimg /<%#Eval("productimg") %>' Height="143" Width="144"/>--%>
                                <asp:Image ID="Image1" runat="server" src='../product /<%#Eval("productimg") %>' Height="143" Width="144"/>
                         ...
                         <div class="form-group row">
                            <label for="input-23" class="col-sm-2 col-form-label">Product Description</label>
                            <div class="col-sm-10">
                                <%--<input type="text" class="form-control" id="input-23" placeholder="Enter Category Description  ">--%>
                                <asp:TextBox ID="txtproduct_desc" runat="server" class="form-control" placeholder="Enter Product Description  "></asp:TextBox>
                            </div>
                        </div>
                         <div class="form-group row">
