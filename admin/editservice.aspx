<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="editservice.aspx.cs" Inherits="The_Bunglow_Cafe.admin.WebForm19" %>
                ...
                <div class="card-body">
                    ...
                    <form runat="server">
                        <div class="form-group row">
                            <label for="input-21" class="col-sm-2 col-form-label">service Id</label>
                            <div class="col-sm-10">
                                <%--<input type="text" class="form-control" id="input-21" placeholder="Enter Your Name">--%>
                                <asp:TextBox ID="txtser_id" runat="server" class="form-control"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <asp:TextBox ID="txtser_name" runat="server" class="form-control"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            <label for="input-22" class="col-sm-2 col-form-label">service Desc</label>
                            <div class="col-sm-10">
                                <%--<input type="text" class="form-control" id="input-22" placeholder="Enter Your Email Address">--%>

                                <asp:TextBox ID="txtser_desc" runat="server" class="form-control"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <asp:Button ID="Button1" class="btn btn-primary px-5" runat="server" Text="Button" OnClick="Button1_Click" />
                            </div>
                        </div>
                    </form>
                </div>
