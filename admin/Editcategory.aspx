<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="Editcategory.aspx.cs" Inherits="The_Bunglow_Cafe.admin.WebForm4" %>
                    ...
                    <form runat="server">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <asp:TextBox ID="txtcat_id" runat="server" class="form-control"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <asp:TextBox ID="txtcat_name" runat="server" class="form-control"></asp:TextBox>
                            </div>
                        </div>
                        <%--<div class="form-group row">
                            <label for="input-23" class="col-sm-2 col-form-label">Category Desc</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="input-23" placeholder="Enter Your Mobile Number">
                                <asp:TextBox ID="txtcat_desc" runat="server" class="form-control"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="input-23" class="col-sm-2 col-form-label">is_active</label>
                            <div class="col-sm-10">
